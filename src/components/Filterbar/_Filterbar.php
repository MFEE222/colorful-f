<div class="filter mt-sm-5 my-sm-3 my-md-5">
    <div class="filter-box">
        ...
        <ul class="sort-icon p-0">
            <li><img src="../../icons/Sortbar/Layout.png"></li>
            <li><img src="../../icons/Sortbar/Rows.png"></li>
            <li><img src="../../icons/Sortbar/Arrow up.png"></li>
            <li><img src="../../icons/Sortbar/Arrow down.png"></li>
        </ul>
