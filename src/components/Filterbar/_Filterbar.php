<div class="filter mt-sm-5 my-sm-3 my-md-5">
    <div class="filter-box d-flex">
        ...
        <ul class="sort-icon d-flex">
            <li><i class="fas fa-search fa-lg"></i>
                <input type="search" class="md-input-style" placeholder="在此輸入關鍵字">
            <li><i class="fas fa-sort-amount-up fa-lg"></i></li>
            <li><i class="fas fa-sort-amount-down-alt fa-lg"></i></li>
        </ul>
