<div class="col-12 col-md-10 member-order-detail-main">
    ...
    <!-- filter bar -->
    <?php include "../../components/MemberOrderFilterBar/_MemberOrderFilterBar.php" ?>

    <div class="order-detail-wall">
        <!-- step progress bar -->
        <?php include "../../components/MemberOrderStepProgressBar/_MemberOrderStepProgressBar.php" ?>
        <!-- 訂購商品卡片 -->
        <div class="order-detail-card">
            <div class="row order-detail-card-body">
                ...
                <div class="col row align-items-center align-content-center">
                    <h5 class="col-12 me-auto order-detail-card-title">Product</h5>
                    <p class="col-9 col-md-6 me-auto order-detail-card-descp">Lorem ipsum dolor sit amet
                        consectetur
                        adipisicing
                        elit.
                        Vitae
                        omnis,
                        distinctio
                        deleniti culpa voluptate odio perferendis quisquam ipsam, doloribus ab nulla hic asperiores?
                        Quaerat
