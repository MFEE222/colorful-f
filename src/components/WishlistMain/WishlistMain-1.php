<div class="product-list">
    ...
    <div class="container d-md-flex d-lg-none justify-content-between my-md-3">
        <div class="phone-search d-flex justify-content-between ">
            <input type="search" class="input-style" placeholder="在此輸入關鍵字">
            <div class="search-icon d-flex my-2">
                <div class="me-2">
                    <img class="icon-img" src="../../icons/Sortbar/Delete.png" alt="">
                </div>
                <div class="me-2">
                    <img class="icon-img" src="../../icons/Sortbar/Search.png" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="phone-filter d-flex justify-content-between my-2">
            ...
            <div class="d-flex justify-content-end align-items-center">
                <div class="dropdown-style my-auto me-2">
                    <select name="filter-select" id="filter-select" class="filter-select">
                        <div class="option-style ">
                            <option value="defalut" selected>篩選</option>
                ...
                <div class="icon-g d-flex">
                    <div class="me-2">
                        <img class="icon-img" src="../../icons/Sortbar/Listview.png" alt="">
                    </div>
                    <div>
                        <img class="icon-img" src="../../icons/Sortbar/Sort.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="banner">
        <div class="banner-img">
            <div class="ratios">
                <img src="../../images/banner-demo-2.png" alt="">
            </div>
        </div>
        <!-- banner遮罩 -->
        ...
        <div class="describe">
            ...
            <p>因其細緻自然的色調而成為人像、和婚禮攝影師的最愛。低對比度柔和的色調這款濾鏡可以讓您營造出美麗而寧靜的美感
        </div>
...
<div class="container">
    <div class="d-none d-lg-block">
        <div class="">
            <?php include "../../components/Filterbar/_Filterbar.php" ?>
        </div>
    </div>
</div>
<!-- card -->
