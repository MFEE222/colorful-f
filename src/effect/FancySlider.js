...
function FancySlider(props) {
    ...
    (function () {
        ...
        function _fncSliderInit($slider, options) {
            ...
            var slidingAT =
                +parseFloat(
                    getComputedStyle($slidesCont)['transition-duration']
                ) * 1000;
            var slidingDelay =
                +parseFloat(getComputedStyle($slidesCont)['transition-delay']) *
                1000;
    ...
    func('.example-slider', { autoSlidingDelay: 4000 });
            ...
            <div className="demo-cont">
                ...
                <div className="demo-cont__credits">
                    ...
                    <a
                        ...
                        target="_blank"
                        className="demo-cont__credits-link"
                        rel="noreferrer"
                    >
                        My codepen
                    </a>
                    ...
                    <a
                        ...
                        rel="noreferrer"
                    >
                        Concept by Kreativa Studio
                    </a>
                    <h4 className="demo-cont__credits-blend">
                        Global Blend Mode
                    </h4>
                    <div className="colorful-switch">
                        ...
                        />
                        <label
                            className="colorful-switch__label"
                            htmlFor="colorful-switch-cb"
                        >
